...
var BulkUpdateWithConfirmButton = function (props) {
    ...
    var _k = (0, ra_core_1.useUpdateMany)(resource, { ids: selectedIds, data: data, meta: mutationMeta }, __assign({ onSuccess: onSuccess, onError: onError, mutationMode: mutationMode }, otherMutationOptions)), updateMany = _k[0], isLoading = _k[1].isLoading;
