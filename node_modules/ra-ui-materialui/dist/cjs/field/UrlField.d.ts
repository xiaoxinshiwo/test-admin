...
export declare const UrlField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>(props: UrlFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface UrlFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType>, AnchorHTMLAttributes<HTMLAnchorElement> {
}
