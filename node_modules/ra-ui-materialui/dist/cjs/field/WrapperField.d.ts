...
export declare const WrapperField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>({ children, }: WrapperFieldProps<RecordType>): JSX.Element;
    displayName: string;
    propTypes: {
...
export interface WrapperFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType> {
    children: ReactNode;
}
