...
export declare const ReferenceField: {
    <RecordType extends Record<string, unknown> = Record<string, any>, ReferenceRecordType extends RaRecord<Identifier> = RaRecord<Identifier>>(props: ReferenceFieldProps<RecordType, ReferenceRecordType>): JSX.Element;
    propTypes: {
        ...
        link: PropTypes.Validator<NonNullable<NonNullable<string | boolean | ((...args: any[]) => any)>>>;
    };
    defaultProps: {
        link: string;
    };
};
export interface ReferenceFieldProps<RecordType extends Record<string, unknown> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord> extends Omit<FieldProps<RecordType>, 'source'>, Required<Pick<FieldProps<RecordType>, 'source'>> {
    children?: ReactNode;
 ...
 */
export declare const NonEmptyReferenceField: <RecordType extends Record<string, unknown> = Record<string, any>, ReferenceRecordType extends RaRecord<Identifier> = RaRecord<Identifier>>({ children, id, reference, queryOptions, link, ...props }: Omit<ReferenceFieldProps<RecordType, ReferenceRecordType>, "source"> & {
    id: Identifier;
}) => JSX.Element;
...
export interface ReferenceFieldViewProps<RecordType extends Record<string, unknown> = Record<string, any>, ReferenceRecordType extends RaRecord = RaRecord> extends FieldProps<RecordType>, UseReferenceResult {
    children?: ReactNode;
    reference: string;
    resource?: string;
    translateChoice?: Function | boolean;
