...
export declare const ImageField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>(props: ImageFieldProps<RecordType>): JSX.Element;
    displayName: string;
    propTypes: {
...
export interface ImageFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType> {
    src?: string;
    title?: string;
    sx?: SxProps;
}
