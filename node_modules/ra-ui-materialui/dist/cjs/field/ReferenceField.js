...
var NonEmptyReferenceField = function (_a) {
    var children = _a.children, id = _a.id, reference = _a.reference, queryOptions = _a.queryOptions, link = _a.link, props = __rest(_a, ["children", "id", "reference", "queryOptions", "link"]);
...
var ReferenceFieldView = function (props) {
    ...
    var link = resourceLinkPath === false ||
        ...
        : createPath({
            ...
            type: typeof resourceLinkPath === 'function'
    ...
    if (link) {
        return (React.createElement(Root, { className: className, sx: sx },
            React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord },
                React.createElement(Link_1.Link, { to: link, className: exports.ReferenceFieldClasses.link, onClick: stopPropagation }, child))));
    }
    return (React.createElement(ra_core_1.RecordContextProvider, { value: referenceRecord }, child));
};
