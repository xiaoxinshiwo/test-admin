...
export declare const ArrayField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>(props: ArrayFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface ArrayFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType> {
    children: ReactNode;
    perPage?: number;
    sort?: SortPayload;
