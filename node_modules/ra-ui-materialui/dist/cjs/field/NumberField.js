...
var NumberFieldImpl = function (props) {
    ...
    return (React.createElement(Typography_1.default, __assign({ variant: "body2", component: "span", className: className }, (0, sanitizeFieldRestProps_1.sanitizeFieldRestProps)(rest)), hasNumberFormat && typeof value === 'number'
        ? value.toLocaleString(locales, options)
        : value));
};
NumberFieldImpl.propTypes = __assign(__assign(__assign({}, Typography_1.default.propTypes), types_1.fieldPropTypes), { locales: prop_types_1.default.oneOfType([
...
exports.NumberField = (0, genericMemo_1.genericMemo)(NumberFieldImpl);
