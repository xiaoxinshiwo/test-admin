...
var TranslatableInputs = function (props) {
    var _a;
    var className = props.className, defaultLocale = props.defaultLocale, locales = props.locales, _b = props.groupKey, groupKey = _b === void 0 ? '' : _b, _c = props.selector, selector = _c === void 0 ? React.createElement(TranslatableInputsTabs_1.TranslatableInputsTabs, { groupKey: groupKey }) : _c, children = props.children, variant = props.variant, margin = props.margin, sx = props.sx;
    ...
    return (React.createElement(Root, { className: (0, clsx_1.default)(className, exports.TranslatableInputsClasses.root, (_a = {},
            _a[exports.TranslatableInputsClasses.fullWidth] = props.fullWidth,
            _a)), sx: sx },
