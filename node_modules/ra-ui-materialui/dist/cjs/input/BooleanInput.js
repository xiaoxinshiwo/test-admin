...
var BooleanInput = function (props) {
    ...
    return (React.createElement(FormGroup_1.default, { className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), row: row, sx: sx },
        React.createElement(FormControlLabel_1.default, { control: React.createElement(Switch_1.default, __assign({ id: id, name: field.name, color: "primary", onChange: handleChange, onFocus: onFocus, checked: Boolean(field.value) }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest), options, { disabled: disabled })), label: React.createElement(ra_core_1.FieldTitle, { label: label, source: source, resource: resource, isRequired: isRequired }) }),
        renderHelperText ? (React.createElement(FormHelperText_1.default, { error: (isTouched || isSubmitted) && invalid },
            React.createElement(InputHelperText_1.InputHelperText, { touched: isTouched || isSubmitted, error: error === null || error === void 0 ? void 0 : error.message, helperText: helperText }))) : null));
};
