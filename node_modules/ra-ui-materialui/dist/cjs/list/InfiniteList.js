...
var InfiniteList = function (_a) {
    var debounce = _a.debounce, disableAuthentication = _a.disableAuthentication, disableSyncWithLocation = _a.disableSyncWithLocation, exporter = _a.exporter, filter = _a.filter, filterDefaultValues = _a.filterDefaultValues, _b = _a.pagination, pagination = _b === void 0 ? defaultPagination : _b, perPage = _a.perPage, queryOptions = _a.queryOptions, resource = _a.resource, sort = _a.sort, storeKey = _a.storeKey, rest = __rest(_a, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "pagination", "perPage", "queryOptions", "resource", "sort", "storeKey"]);
...
exports.InfiniteList.propTypes = {
...
exports.InfiniteList.defaultProps = {
    filter: {},
    perPage: 10,
};
