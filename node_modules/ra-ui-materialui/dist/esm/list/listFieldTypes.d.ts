...
export declare const listFieldTypes: {
    ...
    boolean: {
        component: {
            <RecordType extends Record<string, unknown> = Record<string, any>>(props: import("../field").BooleanFieldProps<RecordType>): JSX.Element;
            propTypes: any;
            displayName: string;
        };
    ...
    date: {
        component: {
            <RecordType_1 extends Record<string, unknown> = Record<string, any>>(props: import("../field").DateFieldProps<RecordType_1>): JSX.Element;
            propTypes: any;
            displayName: string;
        };
        representation: (props: any) => string;
    ...
    email: {
        component: {
            <RecordType_2 extends Record<string, unknown> = Record<string, any>>(props: import("../field").EmailFieldProps<RecordType_2>): JSX.Element;
            propTypes: {
    ...
    id: {
        component: {
            <RecordType_3 extends Record<string, unknown> = Record<string, any>>(props: import("../field").TextFieldProps<RecordType_3>): JSX.Element;
            propTypes: any;
            displayName: string;
        };
        representation: (props: any) => string;
    ...
    number: {
        component: {
            <RecordType_4 extends Record<string, unknown> = Record<string, any>>(props: import("../field").NumberFieldProps<RecordType_4>): JSX.Element;
            propTypes: any;
            displayName: string;
            defaultProps: {
                textAlign: string;
    ...
    reference: {
        component: {
            <RecordType_5 extends Record<string, unknown> = Record<string, any>, ReferenceRecordType extends import("ra-core").RaRecord<import("ra-core").Identifier> = import("ra-core").RaRecord<import("ra-core").Identifier>>(props: import("../field").ReferenceFieldProps<RecordType_5, ReferenceRecordType>): JSX.Element;
            propTypes: {
                ...
                link: import("prop-types").Validator<NonNullable<NonNullable<string | boolean | ((...args: any[]) => any)>>>;
            };
            defaultProps: {
                link: string;
            };
    ...
    url: {
        component: {
            <RecordType_7 extends Record<string, unknown> = Record<string, any>>(props: import("../field").UrlFieldProps<RecordType_7>): JSX.Element;
            propTypes: {
                sortBy: import("prop-types").Requireable<string>;
                sortByOrder: import("prop-types").Requireable<"ASC" | "DESC">;
                source: import("prop-types").Requireable<string>;
