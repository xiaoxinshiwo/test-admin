...
export declare const ReferenceManyField: {
    <RecordType extends RaRecord<import("ra-core").Identifier> = RaRecord<import("ra-core").Identifier>, ReferenceRecordType extends RaRecord<import("ra-core").Identifier> = RaRecord<import("ra-core").Identifier>>(props: ReferenceManyFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface ReferenceManyFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType> {
    children: ReactNode;
