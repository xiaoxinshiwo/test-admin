...
export declare const FileField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>(props: FileFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface FileFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType> {
    src?: string;
    title?: string;
    target?: string;
