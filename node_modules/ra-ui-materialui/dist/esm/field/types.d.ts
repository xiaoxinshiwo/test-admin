...
export interface FieldProps<RecordType extends Record<string, unknown> = Record<string, any>> {
 ...
 */
export interface PublicFieldProps<RecordType extends Record<string, unknown> = Record<string, any>, SortByType = unknown> {
    sortBy?: unknown extends SortByType ? Call<Objects.AllPaths, RecordType> : SortByType;
    sortByOrder?: SortOrder;
