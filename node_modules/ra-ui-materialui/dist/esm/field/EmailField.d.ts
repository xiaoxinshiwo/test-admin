...
export declare const EmailField: {
    <RecordType extends Record<string, unknown> = Record<string, any>>(props: EmailFieldProps<RecordType>): JSX.Element;
    propTypes: {
...
export interface EmailFieldProps<RecordType extends Record<string, unknown> = Record<string, any>> extends FieldProps<RecordType>, Omit<LinkProps, 'textAlign'> {
}
