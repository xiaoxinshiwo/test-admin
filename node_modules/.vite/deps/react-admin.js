...
var SimpleFormIterator = function(props) {
  ...
  var addField = (0, import_react45.useCallback)(function(item) {
    ...
    if (item == null) {
      ...
      !import_react45.Children.only(children).props.source && // Make sure it's not a FormDataConsumer
      import_react45.Children.map(children, function(input) {
        return React72.isValidElement(input) && input.type !== FormDataConsumer_default;
      }).some(Boolean)) {
        defaultValue = "";
      } else {
...
var TranslatableInputs = function(props) {
  var _a13;
  var className = props.className, defaultLocale = props.defaultLocale, locales = props.locales, _b = props.groupKey, groupKey = _b === void 0 ? "" : _b, _c = props.selector, selector = _c === void 0 ? React139.createElement(TranslatableInputsTabs, { groupKey }) : _c, children = props.children, variant = props.variant, margin = props.margin, sx = props.sx;
  var context = useTranslatable({ defaultLocale, locales });
  return React139.createElement(
    Root23,
    { className: clsx_m_default(className, TranslatableInputsClasses.root, (_a13 = {}, _a13[TranslatableInputsClasses.fullWidth] = props.fullWidth, _a13)), sx },
...
var TranslatableInputsClasses = {
  ...
  fullWidth: "".concat(PREFIX61, "-fullWidth")
};
