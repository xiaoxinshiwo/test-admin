...
function HistoryRouter(_a) {
  ...
  return React14.createElement(Router, { basename, children, location: state.location, navigationType: state.action, navigator: history });
}
...
var BasenameContextProvider = function(_a) {
  ...
  return React15.createElement(BasenameContext.Provider, { value: basename }, children);
};
...
var AdminRouter = function(_a) {
  ...
  return React16.createElement(
    ...
    React16.createElement(Router2, { basename, history }, children)
  );
};
var DummyRouter = function(_a) {
  var children = _a.children;
  return React16.createElement(React16.Fragment, null, children);
};
var InternalRouter = function(_a) {
  ...
  return React16.createElement(HistoryRouter, { history: finalHistory }, children);
};
...
var useRedirect = function() {
  ...
  return (0, import_react31.useCallback)(function(redirectTo, resource, id, data, state) {
    ...
    if (!redirectTo) {
      ...
      navigate(createPath2({ resource, id, type: redirectTo }), {
        state: __assign2({ _scrollToTop: true }, state)
      });
      return;
    }
...
var SaveContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React20.createElement(SaveContext.Provider, { value }, children);
};
                ...
                onSuccess: function(data3, variables, context) {
                  return __awaiter7(void 0, void 0, void 0, function() {
                    return __generator7(this, function(_a4) {
                      ...
                      redirect(finalRedirectTo, resource, data3.id, data3);
                      return [
                        2
                        /*return*/
                      ];
...
var RecordContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React21.createElement(RecordContext.Provider, { value }, children);
};
...
var CreateContextProvider = function(_a) {
  ...
  return React22.createElement(
    ...
    React22.createElement(
      ...
      React22.createElement(RecordContextProvider, { value: value && value.record }, children)
    )
  );
};
...
var CreateBase = function(_a) {
  ...
  var body = React23.createElement(CreateContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React23.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
                ...
                onSuccess: function(data3, variables, context) {
                  return __awaiter8(void 0, void 0, void 0, function() {
                    return __generator8(this, function(_a4) {
                      ...
                      redirect(redirectTo, resource, data3.id, data3);
                      return [
                        2
                        /*return*/
                      ];
...
var WithRecord = function(_a) {
  ...
  return record ? React24.createElement(React24.Fragment, null, render(record)) : null;
};
...
var OptionalRecordContextProvider = function(_a) {
  ...
  return value ? React25.createElement(RecordContextProvider, { value }, children) : children;
};
...
var EditContextProvider = function(_a) {
  ...
  return React26.createElement(
    ...
    React26.createElement(
      ...
      React26.createElement(RecordContextProvider, { value: value && value.record }, children)
    )
  );
};
...
var EditBase = function(_a) {
  ...
  var body = React27.createElement(EditContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React27.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
  ...
  return React28.createElement(
    ...
    React28.createElement(
      ...
      React28.createElement(
        ...
        React28.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var InfiniteListBase = function(_a) {
  ...
  return React29.createElement(
    ...
    React29.createElement(
      ...
      React29.createElement(InfinitePaginationContext.Provider, { value: {
...
var ListBase = function(_a) {
  ...
  return React30.createElement(
    ResourceContextProvider,
    { value: props.resource },
    React30.createElement(ListContextProvider, { value: useListController(props) }, children)
  );
};
...
var PreferencesEditorContextProvider = function(_a) {
  ...
  return React34.createElement(PreferencesEditorContext.Provider, { value: context }, children);
};
...
var ResourceDefinitionContextProvider = function(_a) {
  ...
  return React35.createElement(ResourceDefinitionContext.Provider, { value: contextValue }, children);
};
            ...
            React36.createElement(
              ...
              React36.createElement(
                ...
                React36.createElement(
                  ...
                  null,
                  React36.createElement(ResourceDefinitionContextProvider, null, children)
                )
              )
            )
          )
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  import_react108.Children.forEach(children, function(element) {
    if (!React37.isValidElement(element)) {
      return;
    }
...
var CoreAdminRoutes = function(props) {
  ...
  if (status === "empty") {
    return React38.createElement(Ready, null);
  }
  if (status === "loading" || !canRender) {
    return React38.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      oneSecondHasPassed ? React38.createElement(Route, { path: "*", element: React38.createElement(LoadingPage, null) }) : React38.createElement(Route, { path: "*", element: null })
    );
  }
  return React38.createElement(
    Routes,
    null,
    customRoutesWithoutLayout,
    React38.createElement(Route, { path: "/*", element: React38.createElement(
      "div",
      null,
      React38.createElement(
        ...
        React38.createElement(
          ...
          import_react109.Children.map(resources, function(resource) {
            return React38.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource });
          }),
          React38.createElement(Route, { path: "/", element: dashboard ? React38.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard }) : resources.length > 0 ? React38.createElement(Navigate, { to: createPath2({
            resource: resources[0].props.name,
            type: "list"
          }) }) : null }),
          React38.createElement(Route, { path: "*", element: React38.createElement(CatchAll, { title }) })
        )
      )
    ) })
  );
...
var DefaultLayout = function(_a) {
  var children = _a.children;
  return React39.createElement(React39.Fragment, null, children);
};
var CoreAdminUI = function(props) {
  ...
  return React39.createElement(
    Routes,
    null,
    LoginPage !== false && LoginPage !== true ? React39.createElement(Route, { path: "/login", element: createOrGetElement(LoginPage) }) : null,
    LoginCallbackPage !== false && LoginCallbackPage !== true ? React39.createElement(Route, { path: "/auth-callback", element: createOrGetElement(LoginCallbackPage) }) : null,
    React39.createElement(Route, { path: "/*", element: React39.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, menu, requireAuth, ready, title }, children) })
  );
};
...
var CoreAdmin = function(props) {
  ...
  return React40.createElement(
    ...
    React40.createElement(CoreAdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, requireAuth, ready }, children)
  );
};
...
var ResourceContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return value ? React41.createElement(ResourceContext.Provider, { value }, children) : children;
};
...
var Resource = function(props) {
  ...
  return React42.createElement(
    ...
    React42.createElement(
      Routes,
      null,
      create && React42.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React42.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React42.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React42.createElement(Route, { path: "/*", element: getElement(list) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  ...
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    return React42.createElement(ElementOrComponent, null);
  }
  return null;
};
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react115.useCallback)(function(record) {
    ...
    if (React43.isValidElement(recordRepresentation)) {
...
var FieldTitle = function(props) {
  ...
  return React44.createElement(
    ...
    isRequired3 && React44.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
...
var useLayoutEffect3 = typeof window !== "undefined" ? React46.useLayoutEffect : React46.useEffect;
var useEvent = function(fn) {
  var ref = React46.useRef(function() {
...
var LabelPrefixContextProvider = function(_a) {
  ...
  return React47.createElement(LabelPrefixContext.Provider, { value: newPrefix }, children);
};
...
var I18nContextProvider = function(_a) {
  ...
  return isInitialized ? React48.createElement(I18nContext.Provider, { value, key }, children) : null;
};
...
var PreferenceKeyContextProvider = function(_a) {
  ...
  return React49.createElement(PreferenceKeyContext.Provider, { value }, children);
};
...
var FormDataConsumer = function(props) {
  ...
  return React50.createElement(FormDataConsumerView, __assign46({ formData }, props));
};
var FormDataConsumerView = function(props) {
  ...
  if (typeof index !== "undefined" && source) {
    ...
    ret = children(__assign46({ formData }, rest));
  }
...
var ValidationError = function(props) {
  ...
  if (error.message) {
    ...
    return React51.createElement(React51.Fragment, null, translate(message, __assign47({ _: message }, args)));
  }
  return React51.createElement(React51.Fragment, null, translate(error, { _: error }));
};
...
var ChoicesContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React52.createElement(ChoicesContext.Provider, { value }, children);
};
...
var FormGroupsProvider = function(_a) {
  ...
  return React53.createElement(FormGroupsContext.Provider, { value: formContextValue }, children);
};
    ...
    React54.createElement(
      ...
      React54.createElement(
        ...
        React54.createElement(
          FormGroupsProvider,
          null,
          React54.createElement("form", { onSubmit: formHandleSubmit, noValidate, id, className }, children)
        )
      )
    )
  );
...
var FormGroupContextProvider = function(_a) {
  ...
  return React55.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useChoices = function(_a) {
  ...
  var getChoiceText = (0, import_react143.useCallback)(function(choice) {
    if ((0, import_react143.isValidElement)(optionText)) {
      return React56.createElement(RecordContextProvider, { value: choice }, optionText);
    }
...
var InferredElement = (
  ...
  function() {
    ...
    InferredElement2.prototype.getElement = function(props) {
      ...
      return this.children ? (0, import_react149.createElement)(this.type.component, __assign53(__assign53({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
        return child.getElement({ key: index });
      }) : this.children.getElement()) : (0, import_react149.createElement)(this.type.component, __assign53(__assign53({}, this.props), props));
    };
...
var DefaultComponent = function() {
  return React57.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JTMUAEVA.js.map
